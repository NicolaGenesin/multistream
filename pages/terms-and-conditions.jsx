...
const Main = () => (
  <Box bg="gray.500" color="white">
    <Box px="5%" pt="5%">
      <Heading as="h1" py="16px" fontSize={["lg"]}>
      ...
      <p>
        ...
        of multistream.gg's Website, located at multistream.gg.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use multistream.gg if you do not agree to
      ...
      <Heading as="h2" py="16px" fontSize={["sm"]}>
        <strong>Cookies</strong>
      </Heading>

      <p>
        We employ the use of cookies. By accessing multistream.gg, you agreed to
        use cookies in agreement with the multistream.gg's Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, multistream.gg and/or its licensors own the
        intellectual property rights for all material on multistream.gg. All
        intellectual property rights are reserved. You may access this from
        multistream.gg for your own personal use subjected to restrictions set
      ...
      <p>
        ...
        multistream.gg does not filter, edit, publish or review Comments prior
        to their presence on the website. Comments do not reflect the views and
        opinions of multistream.gg,its agents and/or affiliates. Comments
        reflect the views and opinions of the person who post their views and
        opinions. To the extent permitted by applicable laws, multistream.gg
      ...
      <p>
        multistream.gg reserves the right to monitor all Comments and to remove
      ...
      <p>
        You hereby grant multistream.gg a non-exclusive license to use,
      ...
      <p>
        ...
        the hyperlink compensates the absence of multistream.gg; and (d) the
      ...
      <p>
        ...
        e-mail to multistream.gg. Please include your name, your organization
      ...
      <p>
        No use of multistream.gg's logo or other artwork will be allowed for
